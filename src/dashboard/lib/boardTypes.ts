...
export interface BoardData {
   ...
   *  `value` is the ACTIVE count; optional `total` is the number created
   *  (e.g. People: 1225 active of 3714 created) — rendered as an "of N created" caption. */
  portfolio: { name: string; value: number; total?: number; c: string }[]

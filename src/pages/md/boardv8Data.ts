...
export interface BoardData {
  ...
  /** Optional per-pillar division breakdown (agents grouped by domain-pillar × division).
   *  Populated by the live aggregator; undefined for the static/report source. */
  ...
  processes: { pct: string | null; processesAgentic: string | null; activeByDiv: string | null; transformByDiv: string | null; delivery: string | null }

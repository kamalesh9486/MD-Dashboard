/* MD Dashboard shell — header banner + tab bar, routing to the Executive
   ...
   placeholders. Exports BOARD_SECTIONS / BoardSectionId consumed by the app
  ...
  return (
    <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '80px 40px' }}>
      <div style={{ textAlign: 'center', maxWidth: 380 }}>
        <div style={{ width: 72, height: 72, margin: '0 auto', borderRadius: 20, background: '#E4EFE9', display: 'flex', alignItems: 'center', justifyContent: 'center', color: T.green, fontSize: 32 }}>
    ...
    <div className="mdx-shell">
      ...
      <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 24, flexWrap: 'wrap' }}>
        ...
        <div style={{ textAlign: 'right' }}>
          ...
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 7, marginTop: 8, padding: '6px 12px', borderRadius: 999, background: T.bgAmber, border: '1px solid #F6DDB0' }}>
      ...
      {/* TAB BAR */}
      <div className="mdx-tabs" style={{ display: 'flex', gap: 4, marginTop: 22, marginBottom: 26, borderBottom: '1px solid #DCE4E0' }}>
        {TABS.map(t => (
